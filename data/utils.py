...
def parse_pdb_feats(
    ...
    def _process_chain_id(x):
        ...
        return center_and_scale_coords(feat_dict, scale_factor=scale_factor)
...
def write_checkpoint(
    ...
    Args:
        ...
        logger: Pass logger for performing logging, otherwise print to std out directly.
        use_torch: Save with pytorch function instead of pickle.
        delete_previous: Option to delete previous checkpoints from directory prior to saving.
    """
...
def center_and_scale_coords(
    chain_feats: dict[str, Any], scale_factor: float = 1.0
) -> dict[str, Any]:
    """
    Centers the carbon alpha atoms of the chain/structure on the origin.
    Args:
        chain_feats: Dictionary containing features for a chain/structure.
        scale_factor: Factor to scale the distances between CA.

    Returns:
    Scaled and centered dictionary
    """
